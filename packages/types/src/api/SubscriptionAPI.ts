...
export type SubscriptionsGetRequestResponse = PagedResponse<Subscription[]>;
/**
 ...
 */
export interface SubscriptionPurchasesGetRequest extends CommonQueryParams<SubscriptionPurchasesGetRequest> {
 ...
 * {@link https://developers.hotmart.com/payments/api/v1/subscriptions/:subscriber_code/purchases}
 */
export type SubscriptionPurchasesGetRequestResponse = Array<SubscriptionPurchase>;
...
export interface SubscriptionCancelPostRequest {
  subscriber_code: string;
  send_email: boolean;
}
...
export interface SubscriptionListCancelPostRequestResponse {
